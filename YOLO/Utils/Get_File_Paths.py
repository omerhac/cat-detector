...
def ChangeToOtherMachine(filelist, repo="YOLO", remote_machine=""):
    """
    ...
    '/home/ubuntu/YOLO/Data/Street_View_Images/vulnerable/test.jpg'

    Get's converted to

    'C:/Users/Anton/YOLO/Data/Street_View_Images/vulnerable/test.jpg'
